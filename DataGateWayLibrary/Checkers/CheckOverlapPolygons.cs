...
{
    public class CheckOverlapPolygons : BaseChecker, IChecker
    {
        /// <summary>
        /// 检查图层中的重叠面
        /// </summary>
        ...
        public bool CheckData()
        {
            try
            {
                ...
                {
                    Message = "重叠面检查所需图层名为空！请输入正确图层名参数！";
            ...
            {
                Message = "重叠面检查出现异常，错误原因：" + err.Message;
                return false;
            }
        }
    }
