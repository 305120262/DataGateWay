...
{
    public  class CheckPointOnLineEndPoints : BaseChecker, IChecker
    {
        /// <summary>
        /// 点是否在线的端点上检查
        /// </summary>
        ...
        public bool CheckData()
        {
            try
            {
                ...
                {
                    Message = "点是否在线的端点上检查所需参数为空！请输入正确参数！";
                ...
                {
                    Message = "点是否在线的端点上检查所需图层名为空！请输入正确图层名参数！";
                ...
                string strErrorMsg = "错误描述：点不在线的端点上现象！";

                CheckErrorList = CheckerUtil.CheckPointsIsOnLines(layerName, layerName2, strSQL, strSQL2, true, esriSpatialRelEnum.esriSpatialRelIntersects, "T**T*****", strErrorMsg);
                
                return true;
            }
            catch (Exception err)
            {
                Message = "点不在线的端点上检查出现异常，错误原因：" + err.Message;
                return false;
            }
        }
    }
