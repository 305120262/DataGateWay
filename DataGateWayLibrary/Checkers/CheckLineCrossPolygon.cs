...
{
    public class CheckLineCrossPolygon : BaseChecker, IChecker
    {
        /// <summary>
        /// 两集合间线穿越检查
        /// </summary>
        ...
        public bool CheckData()
        {
            try
            {
                ...
                {
                    Message = "两集合间线穿越检查所需参数为空！请输入正确参数！";
                ...
                {
                    Message = "两集合间线穿越检查所需图层名为空！请输入正确图层名参数！";
                ...
                string strErrorMsg = "错误描述：两集合间线穿越现象！";

                CheckErrorList = CheckerUtil.CheckOverlapFeaturesInLayers(layerName, layerName2, strSQL, strSQL2, 23, esriSpatialRelEnum.esriSpatialRelCrosses, "TTTTTTTTT", strErrorMsg);
               
                return true;
            }
            catch (Exception err)
            {
                Message = "两集合间线穿越检查出现异常，错误原因：" + err.Message;
                return false;
            }
        }
    }
