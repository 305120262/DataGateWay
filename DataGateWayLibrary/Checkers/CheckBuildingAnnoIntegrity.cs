...
{
    public class CheckBuildingAnnoIntegrity : BaseChecker, IChecker
    {
        ...
        public bool CheckData()
        {
            ...
            {
                Message = "建筑物注记完整性检查出现异常，错误原因：" + err.Message;
                return false;
            }
        }


        public ArrayList CheckValue(string featAnnotName, string FeatName, string CheckRule, string otherString, string Tolerance, string errorMsg, int[] idValues)
        {
            double tol = 0;
