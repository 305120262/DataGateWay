...
namespace DataGateWay
{
    public partial class CheckerConfigForm : Form
    {
        ...
        {
            string dir = MdbCheckerManager.CheckerConfigsDir;
        ...
        private void LoadSchema()
        {
            if (this.cbxSolution.Text != null)
            {
                ...
                m_filepath = MdbCheckerManager.CheckerConfigsDir + this.cbxSolution.Text + ".xml";
        ...
        private void LoadCheckerParameters(string checkerName)
        {
            ...
            var templates = from c in MdbCheckerManager.CheckerMetaInfo.Descendants("Checker")
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            m_filepath = MdbCheckerManager.CheckerConfigsDir + newSchema + ".xml";
